			...
			<section className="flex flex-col md:flex-row items-start justify-between max-w-6xl py-16 gap-16 w-full mx-auto px-8">
				...
				<div className="flex-1 flex flex-col justify-start items-start text-left">
					...
					<p className="text-gray-600 leading-relaxed max-w-2xl w-full">
						Navegue pelo mapa interativo e descubra bicicletas disponíveis perto
						de você em tempo real. Com apenas alguns cliques, você escolhe a
						melhor opção e garante sua locomoção pelo campus com agilidade e
						segurança.
					</p>
				</div>
			</section>
			...
			<section className="flex flex-col md:flex-row items-start justify-between max-w-6xl py-16 gap-12 w-full mx-auto px-8">
				<div className="flex-1 flex flex-col justify-start items-start text-left">
					...
					<p className="text-gray-600 leading-relaxed max-w-xl w-full">
						A plataforma conecta você a uma comunidade de alunos dispostos a
						compartilhar. Descubra bicicletas próximas, com avaliações reais e
						preços justos. Tudo pensado para facilitar sua vida no campus.
					</p>
				</div>
			...
			<section className="flex flex-col items-center justify-center max-w-6xl py-16 gap-12 w-full mx-auto px-8 text-center">
				...
				<div className="max-w-3xl">
					...
					<p className="text-gray-600 leading-relaxed text-justify">
						Cada pedalada conta! Nossa comunidade cresce a cada dia, tornando a
						mobilidade dentro do campus mais sustentável, econômica e
						colaborativa. Seja para quem empresta ou para quem aluga, estamos
						criando um ecossistema de confiança e benefícios mútuos que
						transforma a forma como nos deslocamos na Unicamp.
					</p>
				</div>
